/*
  ...
  1. Problem
    - Existing functions have parameter name conflicts
    - Need to drop existing functions and policies that depend on them
    - Create new functions with different parameter names

  2. Solution
    - Drop all dependent policies first
    - Drop existing functions with CASCADE
    - Create new functions with new parameter names
    - Recreate all policies with new functions
...
-- Create helper function to check company roles with new parameter names
...
-- Create helper function to check if user is company member with new parameter names
